...
export class MapsComponent implements OnInit {
  ...
  next(){
    ...
    navExtra.state = {
      // "Userworld": this.userworld,
      // "World": this.world
    }
    this.router.navigate(['landingpage'], navExtra);
  }
  ...
  initMap(maps: Maps) {
    ...
    this.map = new maps.Map(this.mapElementRef.nativeElement,opts);
